"""Base data manager for persistent JSON storage.

This module provides the BaseDataManager class that was originally in
plugins/AdminPlugin/BaseDataManager.py. It's now in services/common/ to
avoid circular imports between services and plugins.
"""
import json
import os
import asyncio
